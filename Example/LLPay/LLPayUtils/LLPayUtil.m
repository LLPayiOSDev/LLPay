...
- (NSString *)partnerSignOrder:(NSDictionary *)paramDic {
    ...
    NSArray *keyArray = @[
        @"busi_partner", @"dt_order", @"info_order", @"money_order", @"name_goods", @"no_order", @"notify_url", @"oid_partner", @"risk_item", @"sign_type", @"valid_order", @"repayment_plan", @"repayment_no", @"sms_param"
    ];
